...
arch=i386
Aurl="http://git.oschina.net/chinayin/wdcp/raw/master/rpms"
...
if [ $v1 == 0 ];then
	...
	if [ $arch == "x86_64" ];then
		wget -c http://git.oschina.net/chinayin/wdcp/raw/master/soft/rpmforge-release-0.5.2-2.el6.rf.x86_64.rpm
		rpm -ivh rpmforge-release-0.5.2-2.el6.rf.x86_64.rpm 
	else
		wget -c http://git.oschina.net/chinayin/wdcp/raw/master/soft/rpmforge-release-0.5.2-2.el6.rf.i686.rpm
...
wget -c http://git.oschina.net/chinayin/wdcp/raw/master/rpms/$RF
rpm -ivh $RF --nodeps
I_F=$?
if [ $I_F == 0 ];then
	echo
...
rm -f wdcp_v*
wget -c http://git.oschina.net/chinayin/wdcp/raw/master/soft/wdcp_v2.5.tar.gz > /dev/null 2>&1
