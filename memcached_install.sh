...
###
cd /tmp
wget -c http://git.oschina.net/chinayin/wdcp/raw/master/soft/libevent-1.4.14b-stable.tar.gz
wget -c http://git.oschina.net/chinayin/wdcp/raw/master/soft/memcached-1.4.24.tar.gz
...
if grep -qi 'debian\|ubuntu' /etc/issue; then
    wget http://git.oschina.net/chinayin/wdcp/raw/master/conf/init.d/init.memcached-ubuntu -O /www/wdlinux/init.d/memcached
    ...
    wget http://git.oschina.net/chinayin/wdcp/raw/master/conf/init.d/init.memcached -O /www/wdlinux/init.d/memcached
    chmod 755 /www/wdlinux/init.d/memcached
    ln -s /www/wdlinux/init.d/memcached /etc/init.d/memcached
